...
interface ActionsExternalConsultationProps {
...
const ActionsExternalConsultation: React.FC<ActionsExternalConsultationProps> = ({
  data,
  DeleteDialog,
  EditDialog,
}) => {
...
export default ActionsExternalConsultation;
