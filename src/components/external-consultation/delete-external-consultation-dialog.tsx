...
interface DeleteExternalConsultationDialogProps {
  data: ExternalConsultationManagementRow;
  isOpen: boolean;
  onClose: () => void;
}

const DeleteExternalConsultationDialog: React.FC<DeleteExternalConsultationDialogProps> = ({
  data,
  isOpen,
  onClose,
}) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error('Error al eliminar la consulta externa:', error);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="py-4">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <p className="text-sm text-red-800 dark:text-red-200">
              ¿Está seguro que desea eliminar esta consulta externa?
            </p>
...
export default DeleteExternalConsultationDialog;
